...
class DropdownAdapter1(private val items: List<DataSource>,private val itemsDropdown: List<DataSourceDropdown1>,private val itemsDropdown1: List<DataSourceDropdown1_1> ? = null) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val recyclerViewDropdown: RecyclerView = itemView.findViewById(R.id.dropdown_menu_meal_full1)
        val recyclerViewDropdown1: RecyclerView = itemView.findViewById(R.id.dropdown_menu_meal_full1_1)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.recyclerViewDropdown1.layoutManager = LinearLayoutManager(holder.dropdownLayout.context)
        holder.recyclerViewDropdown1.adapter = itemsDropdown1?.let { DropdownMealFullAdapter1_1(it) }
